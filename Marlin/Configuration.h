...
#define CUSTOM_MACHINE_NAME "B3D TazHS" // <-- changed
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 2.85 // <-- changed
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  37.55 // <-- changed
    #define DEFAULT_Ki   5.39 // <-- changed
    #define DEFAULT_Kd 65.36 // <-- changed
  #endif
#endif // PIDTEMP
 ...
 */
#define DEFAULT_ACCELERATION          1000 // <-- changed:  X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1000 // <-- changed:  X, Y, Z acceleration for travel (non printing) moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {0, -43, -2.35} // <-- changed
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   10 // <-- changed:  Z Clearance for Deploy/Stow
...
#define Y_MIN_POS -22.1 // <-- changed
#define Z_MIN_POS 0
#define X_MAX_POS 301.5 // <-- changed
#define Y_MAX_POS 302.5 // <-- changed
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 7 // <-- changed
  #define GRID_MAX_POINTS_Y 7 // <-- changed
  ...
  #define GRID_MAX_POINTS_X 7 // <-- changed:  Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y 7 // <-- changed
  ...
  #define GRID_MAX_POINTS_X 7 // <-- changed:  Don't use more than 7 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y 7 // <-- changed
...
#define HOMING_FEEDRATE_Z  300 // <-- changed
...
#define NOZZLE_PARK_FEATURE // <-- changed
  ...
  #define NOZZLE_PARK_POINT {100, 301.5, 20} // <-- changed
...
#define TOOLHEAD_NAME "HS 0.8mm" // <-- changed
#define TOOLHEAD_TYPE "HardenedSteel" // <-- changed
